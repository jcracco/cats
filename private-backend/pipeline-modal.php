                ...
                <div className="form-row">
                  <FormField label="Job Link">
                    {editing||isNew
                      ...
                      : form.job_link ? <a href={form.job_link} target="_blank" rel="noreferrer" style={{ fontSize:12,color:"#60a5fa" }}>Open ↗</a> : <span style={{ fontSize:12,color:"var(--text-secondary)" }}>—</span>}
                  </FormField>
                  <FormField label="Dashboard Link">
                    {editing||isNew
                      ...
                      : form.dashboard_link ? <a href={form.dashboard_link} target="_blank" rel="noreferrer" style={{ fontSize:12,color:"#60a5fa" }}>Open ↗</a> : <span style={{ fontSize:12,color:"var(--text-secondary)" }}>—</span>}
                  </FormField>
                </div>
                {isAuth && (
